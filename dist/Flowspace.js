        ...
        connections.map(function (connection) {
          ...
          if (pa && pb) {
            ...
            if (markerStart && !defs[connection.outputColor]) defs[connection.outputColor] = _react2.default.createElement(
              ...
              _react2.default.createElement('path', { d: 'M0,0 L50,20 v8 L0,48 L6,24 Z', fill: connection.outputColor, strokeWidth: '0', opacity: '1' })
            );
            if (markerEnd && !defs[connection.inputColor]) defs[connection.inputColor] = _react2.default.createElement(
              ...
              _react2.default.createElement('path', { d: 'M0,0 L50,20 v8 L0,48 L6,24 Z', fill: connection.inputColor, strokeWidth: '0', opacity: '1' })
            );
